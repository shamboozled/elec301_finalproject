...
public class EMD {
    ...
    public void emdCreate(EmdData emd, int size, int order, int iterations, int locality) {
        emdSetup(emd, order, iterations, locality);
        emdResize(emd, size);
    }

    public void emdDecompose(EmdData emd, double[] signal) {
        int i, j;
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i=0;i<data.length;i++) {
         ...
         System.out.println(Arrays.toString(emdData.imfs[1]));
    }
